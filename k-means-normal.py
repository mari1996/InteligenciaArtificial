...
def execute(arquivo_entrada, palavras, num_clusters, erro, iteracoes):
    #essa funcao faz as execucoes
    #sao varias chamadas feitas ao k-means, variando os parametros numClusters, taxa_erro e iteracoes
    ...
    start = time.time()
    centroid_list = []
    centroid_list = inicializeNormal(vetorNumeros,num_linhas,num_clusters)     
...
def main():
    ...
    y = execute(arquivo_entrada, palavras, num_clusters, erro, iteracoes)
